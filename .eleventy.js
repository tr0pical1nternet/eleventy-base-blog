...
module.exports = function(eleventyConfig) {
  ...
  eleventyConfig.addShortcode("looper", function(slug) {
    ...
    looperSizes.forEach(function(size, index) {
      sources[index] = `<source src="/videos/${slug}_${size}.mp4" type="video/mp4">`;
    });

    return `<div class="looper">
      <video src="/videos/${slug}_${looperSizes[3]}.mp4" class="post-video" width="960" height="640" loop autoplay playsinline>
        ${sources.join('\n')}
